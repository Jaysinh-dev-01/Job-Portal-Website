                        ...
                        <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
                            <select name="category" id="category" class="form-control">
                                ...
                                @if ($newcategories->isNotEmpty())
                                    ...
                                    @endforeach
                                @else
                                    <option value="" disabled>Data no Available</option>
                                @endif
                            </select>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row pt-5">
                @if ($categories->isNotEmpty())
                    ...
                    @endforeach
                @else
                <p style="font-size: 20px" class="text-danger">Data Not Available</p>
                @endif
                    ...
                    <div class="job_lists">
                        <div class="row">
                            @if ($featuredJobs->isNotEmpty())
                                    ...
                                    <div class="col-md-4">
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                ...
                                                <p>
                                                    {{ Str::words($featuredJob->description, 10) }}</p>
                                ...
                                @endforeach
                            @else
                                <p style="font-size: 20px" class="text-danger" class="text-danger">Data Not Available</p>
                            @endif
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                ...
                                                <p>
                                                    {{ Str::words($latestJob->description, 15) }}</p>
                                                <div class="bg-light p-3 border">
                                                    <p class="mb-0">
                                                        <span class="fw-bolder"><i class="fa fa-map-marker"></i></span>
